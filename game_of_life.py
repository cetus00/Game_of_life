...
class SingletonMeta(type):
    """
    Limit creation of class instance to one
    If the instance already created, this instance will be returned
    It also has locks to prevent access to the instance
    """
    _instances = {}
    _lock: Lock = Lock()
...
class GameOfLife(metaclass=SingletonMeta):
    def __init__(self, width=20, height=20, generation=0):
        self.__width = width
